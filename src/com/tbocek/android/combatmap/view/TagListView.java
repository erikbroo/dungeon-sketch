    ...
    private TextView createTextView(final String text) {
        ...
        v.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (mOnTagListAction != null) {
                    mOnTagListAction.onChangeSelectedTag(textView.getText()
                            .toString());
                }
            }
        });

        if (mRegisterChildrenForContextMenu && !text.equals(TokenDatabase.ALL)) {
            ...
            mOnDrag = new View.OnDragListener() {
                ...
                public boolean onDrag(final View view, final DragEvent event) {
                    ...
                    if (event.getAction() == DragEvent.ACTION_DROP) {
                        ...
                        Collection<BaseToken> toAdd = (Collection<BaseToken>) event
                                .getLocalState();
                        if (mOnTagListAction != null) {
                            mOnTagListAction.onDragTokensToTag(toAdd, tv
                                    .getText().toString());
                        }
