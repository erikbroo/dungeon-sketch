...
public final class DrawOptionsView extends LinearLayout {
     ...
     * changes.
     */
    private OnChangeDrawToolListener mOnChangeDrawToolListener = new NullChangeDrawToolListener();
    ...
    public void setBackgroundImageButtonVisibility(boolean visible) {
        this.mBackgroundImageButton.setVisibility(visible ? View.VISIBLE
                : View.GONE);
    ...
    private ImageToggleButton createAndAddMaskButton() {
        final ImageToggleButton maskButton = new ImageToggleButton(
                this.getContext());
    ...
    private void addColorButton(final int color) {
        ...
        b.setLayoutParams(new LinearLayout.LayoutParams(
                ...
                (int) (COLOR_BUTTON_SIZE * getResources().getDisplayMetrics().density)));
        Drawable pencil = this.getContext().getResources()
    ...
    protected void createAndAddEraserButton() {
        final ImageToggleButton eraserButton = new ImageToggleButton(
                this.getContext());
    ...
    protected void createAndAddPanButton() {
        final ImageToggleButton panButton = new ImageToggleButton(
                this.getContext());
    ...
    protected void createAndAddStraightLineButton() {
        final ImageToggleButton button = new ImageToggleButton(
                this.getContext());
