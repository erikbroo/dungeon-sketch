...
public class ArtCreditsView extends LinearLayout {
	...
	public void addArtist(String name, String licenseText, String url) {
		...
		int cellDimension = (int) (getResources().getDisplayMetrics().density * TOKEN_SIZE);
		...
		seperator.setLayoutParams(new LinearLayout.LayoutParams(
				LinearLayout.LayoutParams.MATCH_PARENT, (int) (getResources()
						.getDisplayMetrics().density * SEPERATOR_SIZE)));
	...
	public TokenButton addArtCredit(String name, String resource, String url) {
		TokenButton b = new TokenButton(this.getContext(),
				new BuiltInImageToken(resource, 0, null));
		b.allowDrag(false);
